...
public class VolleyMultipleMultipartRequest extends Request<JSONObject> {
    ...
    public VolleyMultipleMultipartRequest(String url, Map<String, String> headers,
    ...
    public VolleyMultipleMultipartRequest(int method, String url,
                                  Response.Listener<JSONObject> listener,
                                  Response.ErrorListener errorListener) {
