...
public class VolleyMultipartRequestImage extends Request<JSONObject> {
    ...
    public VolleyMultipartRequestImage(String url, Map<String, String> headers,
    ...
    public VolleyMultipartRequestImage(int method, String url,
                                  Response.Listener<JSONObject> listener,
                                  Response.ErrorListener errorListener) {
    ...
    public VolleyMultipartRequestImage(int method, String url, @Nullable Response.ErrorListener listener) {
